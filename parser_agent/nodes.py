...
from parser_agent.dataset_model import (
    ...
    Page,
    city_example,
    page_example, attraction_example,
)
...
def parse_attractions(state: OverallState) -> dict:
    ...
    messages = [
        ...
        HumanMessage(content="Give me an example Json of such output"),
        AIMessage(content=Attractions(cities=[attraction_example]).model_dump_json()),
        HumanMessage(
...
if __name__ == "__main__":
    page_content = ('El Jadida (Arabic: الجديدة, romanized: al-Jadīda, [alʒadiːda]) is a major port city on the Atlantic'
